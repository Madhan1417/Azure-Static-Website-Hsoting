...
export default function Contact() {
  ...
  const contactInfo = [
    {
      icon: Mail,
      title: "Email Us",
      details: ["madhanait@gmail.com", "support@bloomshop.com"],
      description: "Send us an email anytime",
    },
    {
      icon: Phone,
      title: "Call Us",
      details: ["+91 6385799671", "+91 6385799671"],
      description: "Mon-Fri from 8am to 5pm, athuku aporem veetuku poiduven",
    },
    {
      icon: MapPin,
      title: "Visit Us",
      details: ["Chruch Road Street", "GM mills, TN 63167f"],
      description: "Come say hello at our office, IF im not there, say hello to yourself and Leave the place",
    },
    {
      icon: Clock,
      title: "Working Hours",
  ...
  const features = [
    ...
    {
      icon: MessageSquare,
      title: "Quick Response, Because Na summa Na than iruppen",
